...
// nvcc -DUSE_CUDA main.cpp train.cpp guessing.cpp guessing_cuda.cu md5.cpp -o main -O2 -std=c++11
...
int main()
{
    ...
    while (!q.priority.empty())
    {
        ...
        q.PopNext();
        size_t after = q.guesses.size();
        q.total_guesses = after;
        // 统计本次分段计时（由Generate输出）
